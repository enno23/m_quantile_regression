...
load(file = "PLEASE_SET_WD/simulation/pareto_mse_500.RData")

ebs<-ebs[1:50,1:10,1:400]
mqs<-mqs[1:50,1:10,1:400]
MSE_eb<-MSE_eb[1:50,1:10,1:400]
MSE_mq<-MSE_mq[1:50,1:10,1:400]
true<-true[1:50,1:10,1:400]
...
cap=" Pareto errors "
  ...
  print(xtable(as.data.frame(all_tab), caption=paste0("Summary statistics for the relative bias of the  EBP and MQ (SAE) RMSE estimation in the  ", cap, "scenario")), type = "latex", digits=4, file = paste0("Tables/MSE_estimation_", Scenario, ".tex"), include.rownames = F)
  ...
  setkey(all_tab, Indicator)
  print(xtable(as.data.frame(all_tab), caption=paste0("Summary statistics for the RRMSE of the EBP and MQ (SAE) RMSE estimation results in the ", cap, "scenario")), type = "latex", digits=4, file = paste0("Tables/true_mse_", Scenario, ".tex"), include.rownames = F)

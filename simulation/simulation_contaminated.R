...
#==================================================================================================================================#
#-----------------------------------  Scenario 7: Contaminated Normal Error Term ---------------------------------------------------------------#
#==================================================================================================================================#
...
gen_myE=function(dat){
  e1=rnorm(nrow(dat), mean = 0, sd = 1000)
  e2=rnorm(nrow(dat), mean = 0, sd = 6000)
  coin = rbinom(nrow(dat),1,0.95)
  dat["e"]=ifelse(coin==1, e1, e2)
  return(dat)
}
setup=
...
save(list = objects, file = "PLEASE_SET_WD/simulation/cont_point.RData")

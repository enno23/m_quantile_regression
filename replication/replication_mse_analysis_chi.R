load("PLEASE_SET_WD/replication_results_chi_small.RData")
...
table.x                 = xtable(result_table, caption = "Comparision of Original and Replicated Results for the MSE of HCR and PG")
print(table.x, type = "latex", digits=3, file = "Tables/replication_table_chi.tex",include.rownames = FALSE, include.colnames = FALSE)
...
ggsave("Plots/replication_point_chi.pdf",  width = 12, height = 6)
